<template>
    <ion-page>
        <ion-content :fullscreen="true">
            ...
            <div class="contenedor_btns overflow-y-scroll" v-if="unit.i != 22222 && unit.i != 33333 && unit.i != 44444 ">
                <div class="grid grid-cols-2 gap-2 gap-y-0  mr-4 ml-4 "  >
                    <div class="grid grid-cols-12 h-fit shadow-[0_-1px_5px_0px_rgba(0,0,0,0.3)] rounded-lg" @click="CmdParqueoSeguro" :class="btn_parqueoseguro ? 'bg-[#00577B] text-white shadow-[0_-1px_5px_0px_rgba(0,87,123,1)] rounded-lg': 'text-[#00577B]'" >
                        <div class=" grid  col-span-4 justify-center content-center rounded-l-lg ">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 bg-red text-red red" fill="none" viewBox="0 0 24 24" stroke="red" stroke-width="2" :class="btn_parqueoseguro ? 'bg-[#00577B] text-white': 'text-[#00577B]'">
                        ...
                        <div class=" grid  col-span-8 rounded-r-lg">
                            <div class=" grid grid-rows-12 ga-4">
                                ...
                                <div class="row-span-9 p-1 content-center text-justify font-serif text-[10px] pb-3 pr-5">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="grid grid-cols-12 h-fit shadow-[0_-1px_5px_0px_rgba(0,0,0,0.3)] rounded-lg" @click="CmdAperturaDePuertas" :class="btn_aperturaDePuertas ? 'bg-[#00577B] text-white shadow-[0_-1px_5px_0px_rgba(0,87,123,1)] rounded-lg': 'text-[#00577B]'" >
                        <div class=" grid  col-span-4 justify-center content-center rounded-l-lg ">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 bg-red text-red red" fill="none" viewBox="0 0 24 24" stroke="red" stroke-width="2" :class="btn_aperturaDePuertas ? 'bg-[#00577B] text-white': 'text-[#00577B]'">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
                            </svg>
                        </div>
                        <div class=" grid  col-span-8 rounded-r-lg">
                ...
                <div class="grid grid-cols-2 gap-2 gap-y-0  mr-4 ml-4 "  >
                    <div class="grid grid-cols-12 h-fit shadow-[0_-1px_5px_0px_rgba(0,0,0,0.3)] rounded-lg" @click="CmdbloqueoAuto" :class="btn_bloqueoAuto ? 'bg-[#00577B] text-white shadow-[0_-1px_5px_0px_rgba(0,87,123,1)] rounded-lg': 'text-[#00577B]'" >
                        <div class=" grid  col-span-4 justify-center content-center rounded-l-lg ">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 bg-red text-red red" fill="none" viewBox="0 0 24 24" stroke="red" stroke-width="2" :class="btn_bloqueoAuto ? 'bg-[#00577B] text-white': 'text-[#00577B]'">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
                            </svg>
                        </div>
                        <div class=" grid  col-span-8 rounded-r-lg">
                    ...
                    <div class="grid grid-cols-12 h-fit shadow-[0_-1px_5px_0px_rgba(0,0,0,0.3)] rounded-lg" @click="CmdSOS" :class="btn_btnSOS ? 'bg-[#00577B] text-white shadow-[0_-1px_5px_0px_rgba(0,87,123,1)] rounded-lg': 'text-[#00577B]'" >
                        <div class=" grid  col-span-4 justify-center content-center rounded-l-lg ">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 bg-red text-red red" fill="none" viewBox="0 0 24 24" stroke="red" stroke-width="2" :class="btn_btnSOS ? 'bg-[#00577B] text-white': 'text-[#00577B]'">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
                            </svg>
                        </div>
                        <div class=" grid  col-span-8 rounded-r-lg">
...
export default defineComponent({
    ...
    setup() {
        ...
        let sid: any = computed({
            get: () => { return store.getters.sid },
            set: (val) => { store.commit('setSid', val) }
        });
        ...
        const CmdAperturaDePuertas = async () => {
            const alert = await alertController
                .create({
                    ...
                    message: ` ${btn_aperturaDePuertas.value ? '<strong>¿Desea cerrar  las pruebas?</strong>' : '<strong>¿Desea aperturar  las pruebas?</strong> ' }  `,
                    buttons: [{
                            text: 'Cancel',
                            role: 'cancel',
                            cssClass: 'secondary',
                        ...
                        },
                        {
                            ...
                            handler: async () => {
                                if (!btn_aperturaDePuertas.value) {
                                    ...
                                    fdn.append('params', `{"params":[{"svc":"unit/exec_cmd","params":{"itemId":51591,"commandName":"Desactivar puertas","linkType":"","param":"2|","timeout":60,"flags":0}}],"flags":0}`)
        ...
        const CmdParqueoSeguro = async () => {
            const alert = await alertController
                .create({
                    ...
                    message: ` ${btn_parqueoseguro.value ? '<strong>¿Desea desactivar parqueo seguro?</strong>' : '<strong>¿Desea activar parqueo seguro?</strong> ' }  `,
                    buttons: [{
                            text: 'Cancel',
                            role: 'cancel',
                            cssClass: 'secondary',
                        ...
                        },
                        {
                            ...
                            handler: async () => {
                                if (!btn_parqueoseguro.value) {
                                    ...
                                    const response: any = await fetch(`https://plataforma.sesagps.com/wialon/ajax.html?svc=resource/update_zone&sid=${sid.value}`, {
                                        method: 'POST', // *GET, POST, PUT, DELETE, etc.
                                        mode: 'no-cors', // no-cors, *cors, same-origin
                                        cache: 'no-cache', // *default, no-cache, reload, force-cache, only-if-cached
                                        credentials: 'same-origin', // include, *same-origin, omit
        ...
        const CmdbloqueoAuto = async () => {
            const alert = await alertController
                .create({
                    ...
                    message: ` ${btn_bloqueoAuto.value ? '<strong>¿Desea activar el motor?</strong>' : '<strong> ¿Desea desactivar el motor? </strong> ' }  `,
                    buttons: [{
                            text: 'Cancel',
                            role: 'cancel',
                            cssClass: 'secondary',
                        ...
                        },
                        {
                            ...
                            handler: async () => {
                                if (!btn_bloqueoAuto.value) {
                                    ...
                                    fd.append('params', `{"params":[{"svc":"unit/exec_cmd","params":{"itemId":51591,"commandName":"Desbloquear Motor","linkType":"","param":"1|","timeout":60,"flags":0}}],"flags":0}`)
                                    fd.append('sid', sid.value);
        ...
        const CmdSOS = async () => {
            const alert = await alertController
                .create({
                    ...
                    message: ` ${btn_bloqueoAuto.value ? '<strong>¿ESTA SEGURO QUE DESEA ACTIVAR EL BOTON SOS?</strong>' : '<strong>¿ESTA SEGURO QUE DESEA DESACTIVAR EL BOTON SOS?</strong> ' }  `,
                    buttons: [{
                            text: 'Cancel',
                            role: 'cancel',
                            cssClass: 'secondary',
        ...
        const CmdGetUbicacion = async () => {
            const alert = await alertController
                .create({
                    ...
                    message: ` ${btn_get_ubicacion.value ? '<strong>¿Desea Obtener Ubicacion del dispositivo?</strong>' : '<strong>¿Desea Obtener Ubicacion del dispositivo?</strong> ' }  `,
                    buttons: [{
                            text: 'Cancel',
                            role: 'cancel',
                            cssClass: 'secondary',
